...
(setq conseq-font-lock-keywords
      (let* (
	     ;; categories of keywords
	     (conseq-keywords '("include" "inputs+" "outputs+" "run" "executor" "eval"))
	     (conseq-types '("let"))
	     (conseq-functions '("rule" "add-if-missing" "remember-executed"))
	     ...
	     (conseq-functions-regexp (regexp-opt conseq-functions 'words)))
	`(
